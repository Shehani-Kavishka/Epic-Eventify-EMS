...
export default function AttendeeChangePassword(){
    ...
    useEffect(()=>{
        ...
        if(!storedEmail || !storedAttendeeid){
            alert("Email or attendeeid is not found in localstorage. Please log in again");
                ...
                <div className="flex flex-col items-center w-full mb-5">
                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <input 
                            ...
                            className="w-[300px] h-[25px] px-2 py-0.5 border border-gray-300 rounded mt-1 text-center"
                            style={{ backgroundColor: '#F5F5F5' }}
                        />
                    </div>
                </div>
