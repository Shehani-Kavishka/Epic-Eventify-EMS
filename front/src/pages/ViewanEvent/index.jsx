...
export default function ViewanEventPage() {
            ...
            <div className="flex items-center gap-[46px] self-stretch md:flex-col">
              ...
              <div className="flex flex-1 flex-col gap-[67px] md:self-stretch sm:gap-[33px]">
                ...
                <div className="flex items-center justify-between gap-5 sm:flex-col">
                  ...
                  <div className="flex w-[34%] flex-col items-center sm:w-full">
                    ...
                    {/* social media links row section */}
                    {/* <div className="flex w-[62%] justify-between gap-5 md:w-full text-deep_purple-800 text-[24px]">
